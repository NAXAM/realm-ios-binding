...
namespace NxRealm
{
	...
	[Static]
	partial interface RLMErrorConstants
	{
	...
	[Static]
	partial interface RLMSyncConstants
	{
	...
	[BaseType (typeof(NSObject))]
	[DisableDefaultCtor]
	interface RLMResults : RLMCollection, NSFastEnumeration
	{
		// @property (readonly, assign, nonatomic) NSUInteger count;
		[Export ("count")]
		nuint Count { get; }
